...
var about = {
	...
	intro: {
		...
		paragraph2: "Our values:",
		feature1: "Post-launch support",
		feature2: "Consultations, assistance with website launch, basic training.",
		feature3: "Speed and Transparency",
		feature4: "We ensure strict adherence to deadlines and transparent project management so that the client always understands the current status of the project precisely.",
		feature5: "Affordable prices",
		feature6: "We select service packages for any budget and stage of business development."
	}
};
var home = {
	header: {
...
var footer = {
	contact_text: "Let's discuss your project.",
...
var viabon = {
	...
	solution_description: "For the financial company ViaBON, a holistic visual style was developed: corporate colors and fonts were selected, and a brand book with guidelines for using the identity was created. Work is currently underway on the corporate website, including adaptation for various devices.",
	result_title: "Result",
	result_description: "The company has acquired a unified visual image that emphasizes its status and trustworthiness. The new style improves the perception of reliability in the market and creates a sense of premium quality among customers."
};
var penalab = {
	category: "Branding, Website",
	field: "Fashion & Art",
