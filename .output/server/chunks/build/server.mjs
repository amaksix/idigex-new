import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { getCurrentInstance, inject, shallowRef, computed, hasInjectionContext, defineComponent, createElementBlock, provide, cloneVNode, h, defineAsyncComponent, unref, shallowReactive, ref, Suspense, Fragment, createApp, createVNode, Text, toRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, mergeProps, getCurrentScope, withCtx, nextTick, useSSRContext } from 'vue';
import { n as createError$1, w as sanitizeStatusCode, x as getContext, $ as $fetch$1, y as createHooks, z as executeAsync, A as toRouteMatcher, B as createRouter$1, C as defu, D as getRequestURL, E as getRequestHeader, F as parse$1, d as destr, G as klona, H as createDefu, I as isEqual$1, J as setCookie, K as getCookie, L as deleteCookie } from '../_/nitro.mjs';
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-DZGrllwk.mjs').then((m) => m.default || m)),
  error: defineAsyncComponent(() => import('./error-DvEVyoVq.mjs').then((m) => m.default || m)),
  preview: defineAsyncComponent(() => import('./preview-CZAyMNjS.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CXsRtk7v.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CSDKNZgo.mjs'));
...
export { _export_sfc as _, useI18n as a, useLocalePath as b, createError as c, useSwitchLocalePath as d, entry$1 as default, useRouter as e, useNuxtApp as f, useRuntimeConfig as g, hasProtocol as h, withoutTrailingSlash as i, joinURL as j, nuxtLinkDefaults as k, navigateTo as n, parseQuery as p, resolveRouteObject as r, useHead as u, withTrailingSlash as w };
