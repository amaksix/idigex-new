  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="hover-anim"${_scopeId}>${ssrInterpolate(unref(t)("menu.home"))}</span>`);
          } else {
            return [
              createVNode("span", { class: "hover-anim" }, toDisplayString(unref(t)("menu.home")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="hover-anim"${_scopeId}>${ssrInterpolate(unref(t)("menu.about"))}</span>`);
          } else {
            return [
              createVNode("span", { class: "hover-anim" }, toDisplayString(unref(t)("menu.about")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="hover-anim"${_scopeId}>${ssrInterpolate(unref(t)("menu.projects"))}</span>`);
          } else {
            return [
              createVNode("span", { class: "hover-anim" }, toDisplayString(unref(t)("menu.projects")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="hover-anim"${_scopeId}>${ssrInterpolate(unref(t)("menu.contacts"))}</span>`);
          } else {
            return [
              createVNode("span", { class: "hover-anim" }, toDisplayString(unref(t)("menu.contacts")), 1)
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=Footer1-3CTnESX3.mjs.map
